...
export { AssetsDataSource, FileDataSource, HttpDataSource, MemoryDataSource, } from "./source.js";
export { CfbDataClient, DatasetError, createClient } from "./client.js";
...
export function createFileClient(root) {
...
export function createMemoryClient(entries) {
